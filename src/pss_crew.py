...
def __create_character_details_from_info(character_info: EntityInfo, characters_data: EntitiesData, collections_data: EntitiesData, level: int) -> entity.entity.EntityDetails:
    return entity.entity.EntityDetails(
        character_info,
        __properties["character_title"],
        __properties["character_description"],
        __properties["character_properties"],
        __properties["character_embed_settings"],
        characters_data,
        collections_data,
        level=level,
    )
...
def __create_characters_details_collection_from_infos(
    characters_designs_infos: List[EntityInfo], characters_data: EntitiesData, collections_data: EntitiesData, level: int
...
def __create_collection_details_from_info(collection_info: EntityInfo, collections_data: EntitiesData, characters_data: EntitiesData) -> entity.entity.EntityDetails:
    return entity.entity.EntityDetails(
        collection_info,
        __properties["collection_title"],
        __properties["collection_description"],
        __properties["collection_properties"],
        __properties["collection_embed_settings"],
        collections_data,
        characters_data,
    )
...
def __create_prestige_from_details_from_info(character_info: EntityInfo) -> entity.entity.EntityDetails:
    result = entity.entity.EntityDetails(
        character_info, __properties["prestige_from_title"], entity.NO_PROPERTY, __properties["prestige_from_properties"], __properties["character_embed_settings"], prefix="> "
    )
    return result
...
def __create_prestige_to_details_from_info(character_info: EntityInfo) -> entity.entity.EntityDetails:
    result = entity.entity.EntityDetails(
        character_info, __properties["prestige_to_title"], entity.NO_PROPERTY, __properties["prestige_to_properties"], __properties["character_embed_settings"], prefix="> "
    )
    return result
...
characters_designs_retriever = entity.EntityRetriever(CHARACTER_DESIGN_BASE_PATH, CHARACTER_DESIGN_KEY_NAME, CHARACTER_DESIGN_DESCRIPTION_PROPERTY_NAME, cache_name="CharacterDesigns")


collections_designs_retriever = entity.EntityRetriever(COLLECTION_DESIGN_BASE_PATH, COLLECTION_DESIGN_KEY_NAME, COLLECTION_DESIGN_DESCRIPTION_PROPERTY_NAME, cache_name="CollectionDesigns")


__properties: entity.EntityDetailsCreationPropertiesCollection = {
    "character_title": entity.EntityDetailPropertyCollection(entity.EntityDetailProperty("Title", False, omit_if_none=False, transform_function=__get_name_with_level)),
    "character_description": entity.EntityDetailPropertyCollection(
        entity.EntityDetailProperty("Description", False, omit_if_none=False, entity_property_name="CharacterDesignDescription"), property_short=entity.NO_PROPERTY
    ),
    ...
    "collection_title": entity.EntityDetailPropertyCollection(entity.EntityDetailProperty("Title", False, entity_property_name=COLLECTION_DESIGN_DESCRIPTION_PROPERTY_NAME)),
    "collection_description": entity.EntityDetailPropertyCollection(entity.EntityDetailProperty("Description", False, entity_property_name="CollectionDescription"), property_short=entity.NO_PROPERTY),
    ...
    "prestige_from_properties": entity.EntityDetailPropertyListCollection([entity.EntityDetailProperty("2nd crew", False, transform_function=__get_prestige_names)]),
    ...
    "prestige_to_properties": entity.EntityDetailPropertyListCollection([entity.EntityDetailProperty("2nd crew", False, transform_function=__get_prestige_names)]),
}
