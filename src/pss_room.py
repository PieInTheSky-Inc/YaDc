...
__DISPLAY_NAMES: Dict[str, Dict[str, str]] = {
    "ap_dmg": {"default": "AP dmg"},
    "build_cost": {"default": "Build cost"},
    "build_time": {"default": "Build time"},
    "build_requirement": {"default": "Build requirement"},
    "cap_per_hundredth": {
        "default": "Cap per hundredth",
        "Lift": "Speed",
    },
    "cap_per_tick": {"default": "Cap per tick", "Radar": "Cloak reduction", "Stealth": "Cloak duration"},
    "category": {"default": "Category"},
    "cooldown": {"default": "Cooldown"},
    "construction_type": {"default": "Construction type", "Storage": "Storage type"},
    "crew_dmg": {"default": "Crew dmg"},
    "emp_duration": {"default": "EMP duration"},
    "enhanced_by": {"default": "Enhanced by"},
    "gas_per_crew": {"default": "Gas per crew"},
    "grid_types": {"default": "Grid types"},
    "hull_dmg": {"default": "Hull dmg"},
    "innate_armor": {"default": "Innate armor"},
    "manufacture_speed": {"default": "Manufacture speed"},
    "max_crew_blend": {"default": "Max crew blend"},
    "max_power_used": {"default": "Max power used"},
    "max_storage": {
        "default": "Max storage",
        "Bedroom": "Crew slots",
    ...
    "min_hull_lvl": {"default": "Min ship lvl"},
    "more_info": {"default": "More info"},
    "power_generated": {"default": "Power generated"},
    "queue_limit": {"default": "Queue limit", "Council": "Donation limit", "Printer": "Bux per day", "Shield": "Restore on reload"},
    "reload_speed": {"default": "Reload speed"},
    "required_item": {"default": "Required item"},
    "required_research": {"default": "Required research"},
    "shield_dmg": {"default": "Shield dmg"},
    "shots_fired": {"default": "Shots fired"},
    "size": {"default": "Size (WxH)"},
    "system_dmg": {"default": "System dmg"},
    "type": {"default": "Type"},
    "wikia": {"default": "Wiki"},
}
...
def __create_room_details_from_info(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData
) -> entity.EntityDetails:
    return entity.EntityDetails(
        room_info, __properties["title"], __properties["description"], __properties["properties"], __properties["embed_settings"], rooms_data, items_data, researches_data, rooms_designs_sprites_data
    )


def __create_room_details_list_from_infos(
    rooms_designs_infos: List[EntityInfo], rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData
) -> List[entity.EntityDetails]:
...
def __create_rooms_details_collection_from_infos(
    rooms_designs_infos: List[EntityInfo], rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData
...
def __get_capacity_per_tick(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
...
def __get_capacity_per_hundredth(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
        room_type = room_info.get(ROOM_DESIGN_TYPE_PROPERTY_NAME)
...
async def __get_interior_sprite_url(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
...
def __get_is_allowed_in_extension_grids(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
...
def __get_max_storage_and_type(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
        capacity = room_info.get("Capacity")
        ...
        room_type = room_info.get(ROOM_DESIGN_TYPE_PROPERTY_NAME)
        if entity.entity_property_has_value(capacity) and (
            (not entity.entity_property_has_value(manufacture_capacity) or not entity.entity_property_has_value(manufacture_rate)) or (room_type and room_type == "Recycling")
        ):
        ...
        if value:
            print_type = (entity.entity_property_has_value(capacity) and not entity.entity_property_has_value(manufacture_rate)) or (
                entity.entity_property_has_value(manufacture_capacity) and entity.entity_property_has_value(manufacture_rate)
            )
            if print_type:
                construction_type = ""
...
def __get_property_display_name(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
...
async def __get_random_exterior_sprite_url(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    room_design_id = room_info.get(ROOM_DESIGN_KEY_NAME)
    if entity.entity_property_has_value(room_design_id):
...
async def __get_required_item(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
        requirement_string = room_info.get("RequirementString")
        if requirement_string and "item" in requirement_string.lower():
...
async def __get_required_research(
    room_info: EntityInfo, rooms_data: EntitiesData, items_data: EntitiesData, researches_data: EntitiesData, rooms_designs_sprites_data: EntitiesData, **kwargs
) -> Optional[str]:
    if __is_allowed_room_type(room_info, kwargs.get("allowed_room_types"), kwargs.get("forbidden_room_types")):
        requirement_string = room_info.get("RequirementString")
        if requirement_string and "research" in requirement_string.lower():
...
def get_room_info_progression(room_info: EntityInfo, rooms_data: EntitiesData) -> List[EntityInfo]:
    ...
    result = sorted(
        [
            ...
            if room_info["RootRoomDesignId"] == root_room_info[ROOM_DESIGN_KEY_NAME] and not entity.entity_property_has_value(room_info["RequirementString"])
        ],
        key=lambda x: x[ROOM_DESIGN_DESCRIPTION_PROPERTY_NAME],
    )
    return result
...
async def create_room_sprite(
    room_sprite_id: str, room_decoration_sprite: Image.Image, room_design_info: entity.EntityInfo, brightness_value: float, hue_value: float, saturation_value: float
) -> Image.Image:
...
async def make_room_frame_sprite(room_frame_sprite_id: str, room_width: int, room_height: int) -> Image.Image:
    ...
    upper_left_region_sprite = room_frame_sprite.crop((0, 0, from_left, from_left))
    upper_right_region_sprite = room_frame_sprite.crop((room_frame_sprite.width - from_right, 0, room_frame_sprite.width, from_left))
    bottom_left_region_sprite = room_frame_sprite.crop((0, room_frame_sprite.height - from_right, from_left, room_frame_sprite.height))
    bottom_right_region_sprite = room_frame_sprite.crop((room_frame_sprite.width - from_right, room_frame_sprite.height - from_right, room_frame_sprite.width, room_frame_sprite.height))

    top_center_region_sprite = room_frame_sprite.crop((from_left + 1, 0, from_left + 1 + sprites.TILE_SIZE, from_left))
    bottom_center_region_sprite = room_frame_sprite.crop((from_left + 1, room_frame_sprite.height - from_right, from_left + 1 + sprites.TILE_SIZE, room_frame_sprite.height))
    left_center_region_sprite = room_frame_sprite.crop((0, from_left + 1, from_left, from_left + 1 + sprites.TILE_SIZE))
    right_center_region_sprite = room_frame_sprite.crop((room_frame_sprite.width - from_right, from_left + 1, room_frame_sprite.width, from_left + 1 + sprites.TILE_SIZE))
    ...
    for x in range(1, room_width):
        result.paste(top_center_region_sprite, (from_left + (x - 1) * sprites.TILE_SIZE, 0), top_center_region_sprite)
        result.paste(bottom_center_region_sprite, (from_left + (x - 1) * sprites.TILE_SIZE, result.height - from_right), bottom_center_region_sprite)
    for y in range(1, room_height):
        result.paste(left_center_region_sprite, (0, from_left + (y - 1) * sprites.TILE_SIZE))
        result.paste(right_center_region_sprite, (result.width - from_right, from_left + (y - 1) * sprites.TILE_SIZE))
    return result
...
missiles_designs_retriever: entity.EntityRetriever = entity.EntityRetriever(
    MISSILE_DESIGN_BASE_PATH, MISSILE_DESIGN_KEY_NAME, MISSILE_DESIGN_DESCRIPTION_PROPERTY_NAME, cache_name="MissileDesignSprites"
)
rooms_designs_retriever: entity.EntityRetriever = entity.EntityRetriever(
    ROOM_DESIGN_BASE_PATH, ROOM_DESIGN_KEY_NAME, ROOM_DESIGN_DESCRIPTION_PROPERTY_NAME, cache_name="RoomDesigns", sorted_key_function=_get_key_for_room_sort
)
rooms_designs_purchases_retriever: entity.EntityRetriever = entity.EntityRetriever(
    ROOM_DESIGN_PURCHASE_BASE_PATH, ROOM_DESIGN_PURCHASE_KEY_NAME, ROOM_DESIGN_PURCHASE_DESCRIPTION_PROPERTY_NAME, cache_name="RoomDesignPurchases"
)
rooms_designs_sprites_retriever: entity.EntityRetriever = entity.EntityRetriever(ROOM_DESIGN_SPRITES_BASE_PATH, ROOM_DESIGN_SPRITES_KEY_NAME, None, cache_name="RoomDesignSprites")
...
__properties: entity.EntityDetailsCreationPropertiesCollection = {
    "title": entity.EntityDetailPropertyCollection(entity.EntityDetailProperty("Room name", False, omit_if_none=False, transform_function=__get_room_name)),
    "description": entity.EntityDetailPropertyCollection(
        entity.EntityDetailProperty("Description", False, omit_if_none=False, entity_property_name="RoomDescription"), property_short=entity.NO_PROPERTY
    ),
    "properties": entity.EntityDetailPropertyListCollection(
        [
            ...
            entity.EntityDetailProperty(
                __display_name_properties["max_storage"],
                True,
                transform_function=__get_max_storage_and_type,
                forbidden_room_types=["Anticraft", "Corridor", "Lift", "Radar", "Reactor", "Stealth", "Training"],
            ),
            ...
            entity.EntityDetailProperty(
                __display_name_properties["max_crew_blend"], True, entity_property_name="ManufactureCapacity", transform_function=__get_value, allowed_room_types=["Recycling"]
            ),
