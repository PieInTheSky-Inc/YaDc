...
__items_designs_data = await items_designs_retriever.get_data_dict3()
__allowed_item_names = sorted(__get_allowed_item_names(__items_designs_data))
del(__items_designs_data)
