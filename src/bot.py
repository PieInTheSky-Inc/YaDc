...
from .cogs import CurrentDataCog, GeneralCog, TournamentDataCog
...
async def on_ready() -> None:
    ...
    print(f'Loading cog "{CurrentDataCog.qualified_name}" from extension "src.cogs.current"')
    BOT.load_extension('src.cogs.current')
    if settings.FEATURE_TOURNEYDATA_ENABLED:
        print(f'Loading cog "{TournamentDataCog.qualified_name}" from extension "src.cogs.tournament"')
